...
class Register extends Component {
    ...
    handleClick = event => {
        ...
        const passwordRepeat = this.state.password2;
    ...
    render() {
        return (
            <div className='register-box'>
                {/*<p className='register-close'>Zamknij</p>*/}
                <div className='register-form-box'>
                    ...
                    <div className='register-form-btns'>
                        ...
                        <button className='register-form-btn' onClick={this.handleClick}>Załóż konto</button>
                    </div>
                </div>
            </div>
        )
